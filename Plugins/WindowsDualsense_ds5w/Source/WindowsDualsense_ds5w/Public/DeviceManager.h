...
DECLARE_MULTICAST_DELEGATE(FOnDualSenseConnected);
DECLARE_MULTICAST_DELEGATE(FOnDualSenseDisconnected);
...
public:
	 ...
	 */
	void HandleInputDeviceConnectionChange(EInputDeviceConnectionState InputDeviceConnectionState, FPlatformUserId PlatformUserId, FInputDeviceId InputDeviceId);
	/**
	 * The Listener function
	 * Runs every time a controller connects or disconnects
	 */
	...
	FOnDualSenseConnected OnDualSenseConnected;
	FOnDualSenseDisconnected OnDualSenseDisconnected;
