...
DECLARE_MULTICAST_DELEGATE(FOnDeviceManagerReady);
...
public:
	...
	static FWindowsDualsense_ds5wModule& Get()
	{
		return FModuleManager::LoadModuleChecked<FWindowsDualsense_ds5wModule>(
			TEXT("WindowsDualsense_ds5w"));
	}	
	...
	TSharedPtr<DeviceManager> GetDeviceManager() const { return DeviceInstance; }
	FOnDeviceManagerReady DeviceManagerReady;	
private:
